...
//		objets.add(new Pew(gl));
//		objets.add(new Halfwall(gl));
		objets.add(new Floor(gl));
//		objets.add(new BackWall(gl));
//		objets.add(new Wall(gl));
//		objets.add(new Colunas(gl));
		return objets;
	}
	...
	protected void initLight(GL2 gl) {
		...
		// gl.glMaterialfv(GL2.GL_FRONT, GL2.GL_SPECULAR, specularLightArray,
		// 0);
